...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DockView.setMinimumSize(QSize(145, 42))
        ...
        sizePolicy3.setHeightForWidth(self.ViewTab.sizePolicy().hasHeightForWidth())
        self.ViewTab.setSizePolicy(sizePolicy3)
        self.VQuick = QWidget()
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 194, 248))
