...
from BaseMod.Palettes.PaletteParser import palette_parser, CSSPaletizer
from BaseMod.Palettes.Theme_palettes.MoonlightDark import MoonlightDark



class MoonlightDark(Palette):
    ...
    def get_stylesheet(self):
        #print(CSSPaletizer("palette1.png",MoonlightDark)) #TODO make it import from a file instead of being... this
        return (CSSPaletizer("palette0.png","""
            QToolTip {
