...
class Ui_Tiles(object):
    def setupUi(self, Tiles):
        ...
        icon2 = QIcon()
        icon2.addFile(u":/geoIcons/geo/line.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.ToolTilesM1Select.addItem(icon2, "")
        icon3 = QIcon()
        icon3.addFile(u":/geoIcons/geo/rect.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.ToolTilesM1Select.addItem(icon3, "")
        icon4 = QIcon()
        icon4.addFile(u":/geoIcons/geo/rect_hollow.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.ToolTilesM1Select.addItem(icon4, "")
        icon5 = QIcon()
        icon5.addFile(u":/geoIcons/geo/circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.ToolTilesM1Select.addItem(icon5, "")
        icon6 = QIcon()
        icon6.addFile(u":/geoIcons/geo/circle_hollow.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, Tiles):
        ...
        self.ToolTilesM1Select.setItemText(2, QCoreApplication.translate("Tiles", u"Line", None))
        self.ToolTilesM1Select.setItemText(3, QCoreApplication.translate("Tiles", u"Rectangle", None))
        self.ToolTilesM1Select.setItemText(4, QCoreApplication.translate("Tiles", u"Hollow Rectangle", None))
        self.ToolTilesM1Select.setItemText(5, QCoreApplication.translate("Tiles", u"Circle", None))
        self.ToolTilesM1Select.setItemText(6, QCoreApplication.translate("Tiles", u"Hollow Circle", None))
        ...
        self.ToolTilesM2Select.setItemText(2, QCoreApplication.translate("Tiles", u"Line", None))
        self.ToolTilesM2Select.setItemText(3, QCoreApplication.translate("Tiles", u"Rectangle", None))
        self.ToolTilesM2Select.setItemText(4, QCoreApplication.translate("Tiles", u"Hollow Rectangle", None))
