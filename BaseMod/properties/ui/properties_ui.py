...
class Ui_Properties(object):
    def setupUi(self, Properties):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 370, 579))
        ...
        self.gridLayout_10.addWidget(self.WidthCams, 3, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.ToolsPropertiesLabel_10, 2, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.ToolsPropertiesLabel_8, 2, 0, 1, 1)

        self.HeightCells = QSpinBox(self.scrollAreaWidgetContents)
        self.HeightCells.setObjectName(u"HeightCells")

        self.gridLayout_10.addWidget(self.HeightCells, 1, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.ToolsPropertiesLabel_2, 0, 1, 1, 1)

        self.HeightCams = QDoubleSpinBox(self.scrollAreaWidgetContents)
        self.HeightCams.setObjectName(u"HeightCams")

        self.gridLayout_10.addWidget(self.HeightCams, 3, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.ToolsPropertiesLabel, 0, 0, 1, 1)

        self.WidthCells = QSpinBox(self.scrollAreaWidgetContents)
        self.WidthCells.setObjectName(u"WidthCells")

        self.gridLayout_10.addWidget(self.WidthCells, 1, 0, 1, 1)
        ...
        self.verticalLayout_2.addWidget(self.ToolsPropertiesLabel_9)

        self.TileSeed = QSlider(self.scrollAreaWidgetContents)
        self.TileSeed.setObjectName(u"TileSeed")
        self.TileSeed.setOrientation(Qt.Orientation.Horizontal)

        self.verticalLayout_2.addWidget(self.TileSeed)
