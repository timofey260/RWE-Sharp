...
class RaspberryDark(Theme):
    def __init__(self, mod):
        ...
        self.colors = [
            ...
            # accent colors
            ColorConfigurable(mod, "@accent_light", QColor.fromString("#FFCCCC"), "Accent light color"),
            ColorConfigurable(mod, "@accent_medium", QColor.fromString("#FF6666"), "Accent medium color"),
            ColorConfigurable(mod, "@accent_dark", QColor.fromString("#CC0000"), "Accent dark color"),
            ...
            ColorConfigurable(mod, "@alt_text_misc", QColor.fromString("#9A9A9A"),
                              "Alternative miscellaneous text color"),
            ColorConfigurable(mod, "@alt_border_dark", QColor.fromString("#0A0A0A"), "Alternative border dark color"),
            ColorConfigurable(mod, "@alt_border_medium", QColor.fromString("#3A3A3A"),
                              "Alternative border medium color"),
            ...
            ColorConfigurable(mod, "@alt_text_disabled", QColor.fromString("#9A9A9A"),
                              "Alternative text disabled color"),
            ...
            ColorConfigurable(mod, "@alt_accent_medium", QColor.fromString("#FF5555"),
                              "Alternative accent medium color"),
